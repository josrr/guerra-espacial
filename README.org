...
The starfield data is taken from [[https://www.masswerk.at/spacewar/sources/stars_by_prs_for_sw2b_mar62.txt][this file]].
...
This must produce the file =./bin/guerra-espacial=. A copy of the executable can be [[https://guerra-espacial.rufina.link/guerra-espacial][downloaded here]].
